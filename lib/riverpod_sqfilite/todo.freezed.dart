...
mixin _$Todo implements DiagnosticableTreeMixin {
 ...
 int get id; String get description; bool get completed;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('description', description))..add(DiagnosticsProperty('completed', completed));
}
...
@useResult
$Res call({
 int id, String description, bool completed
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String description,  bool completed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Todo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String description,  bool completed)  $default,) {final _that = this;
switch (_that) {
case _Todo():
return $default(_that.id,_that.description,_that.completed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String description,  bool completed)?  $default,) {final _that = this;
switch (_that) {
case _Todo() when $default != null:
return $default(_that.id,_that.description,_that.completed);case _:
  return null;
...
class _Todo with DiagnosticableTreeMixin implements Todo {
  const _Todo({required this.id, required this.description, required this.completed});
